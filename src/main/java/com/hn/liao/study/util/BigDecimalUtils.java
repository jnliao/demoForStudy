...
public class BigDecimalUtils {
    ...
    public static boolean isEqual(BigDecimal first, BigDecimal second) {
        if (first == null || second == null) {
            throw new NullPointerException("input bigDecimal should not be null");
        }
        return first.compareTo(second) == 0;
    }

    public static boolean isSmaller(BigDecimal first, BigDecimal second) {
        if (first == null || second == null) {
            throw new NullPointerException("input bigDecimal should not be null");
        }
        return first.compareTo(second) < 0;
    ...
    public static boolean isSmallerOrEqual(BigDecimal first, BigDecimal second) {
        if (first == null || second == null) {
            throw new NullPointerException("input bigDecimal should not be null");
        }
        return first.compareTo(second) <= 0;
    ...
    public static boolean isBiggerOrEqual(BigDecimal first, BigDecimal second) {
        if (first == null || second == null) {
            throw new NullPointerException("input bigDecimal should not be null");
        }
        return first.compareTo(second) >= 0;
    ...
    public static boolean isSmallerZero(BigDecimal amount) {
        return isSmaller(amount, BigDecimal.ZERO);
    }

    public static boolean isSmallerOrEqualZero(BigDecimal amount) {
        return isSmallerOrEqual(amount, BigDecimal.ZERO);
    }

    public static boolean isBiggerZero(BigDecimal amount) {
        return isBigger(amount, BigDecimal.ZERO);
    }

    public static boolean isBiggerOrEqualZero(BigDecimal amount) {
        return isBiggerOrEqual(amount, BigDecimal.ZERO);
    }
}
